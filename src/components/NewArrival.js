...
const NewArrival = () => {
  ...
  return (
    <div className="container mx-auto">
      <h3 className="text-[29px] mb-5">New arrivals</h3>
      <div className="flex gap-5">
        {NewProduct.map((product) => {
          ...
          return (
            <div
              key={id}
              className="group relative w-fit p-3 bg-white border-2 border-secondary-extraLight hover:border-secondary-light"
            >
              ...
              <div>
                ...
                <h5 className="group-hover:hidden text-[14px] font-semibold">₦{price}</h5>
